...
gpu-vendor-model-matrix.table.tex: table-template--legend.in.tex table-template--table.in.tex table-template--descriptions.in.tex render_table.py compat.yml Makefile
